...
const Home = () => {
    ...
    dispatch({
      ...
      message:
        +new Date() > +new Date(checkIn) || +new Date() > +new Date(checkOut)
          ...
          : "Set checkout date later than check-in",
  ...
  return (
    <>
      ...
      <div className="contentWrapper">
        <div className="content">
          <div className="topBanner">
            ...
            <div className="tabs">
              <div className="selected">Accommodation</div>
              <div>Flights</div>
              <div>Experiences</div>
            </div>
            <Connect />
      ...
      <div className="heading">List With OpenStay Now</div>
      <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScKagW66jeDWBSoxRzt9dbDrPEWnFpsj3747DRnGHuVT89l9g/viewform?embedded=true" width="1425" height="1873" frameborder="0" margin-height="1260" margin-width="1260">Loading…</iframe>
    </>
  );
};
